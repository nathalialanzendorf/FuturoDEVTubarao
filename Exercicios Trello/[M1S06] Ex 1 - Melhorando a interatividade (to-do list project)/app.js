...
function update(){
  ...
  newTask.innerHTML = 
    `
      ...
      <td class="border"><label class="labelCheck" id="check4Label" for="check4Label">E${task}</label></td>
...
check4.addEventListener("change", function() {
  if (check4.checked) {
    document.getElementById("check4Label").style.textDecoration = "line-through";
  }else {
    document.getElementById("check4Label").style.textDecoration = "none";
  }
});
